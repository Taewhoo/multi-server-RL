...
class GenerationHyperparameters:
    ...
    stop: Optional[List[str]] = field(
        default=None,
        metadata={"help": "One or multiple stop words. Generation will stop if one of these words is sampled."}
    )
...
class SGLangConfig:
    ...
    def build_cmd(
        ...
        return f"{sys.executable} -m sglang.launch_server {' '.join(flags)}"
