...
class RemoteSGLangEngine(InferenceEngine):
    ...
    def __init__(self, config: InferenceEngineConfig, worker_id=None):
        self.config = config
        ...
        if worker_id is not None:
            global logger
            logger = logging.getLogger(__name__ + f"@ {worker_id}")
    ...
    def prepare_batch(
        ...
        return self.workflow_executor.prepare_batch(dataloader, workflow, expected_batch_size=expected_batch_size)
